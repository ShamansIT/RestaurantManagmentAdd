...
public class MenuLunchController extends DishHeadController implements SceneSwitch {
    ...
    void initialize() throws SQLException {
        ...
        addDish1.setOnAction(actionEvent ->{
            setAmountRefresh();
            try { loadDishLine(1,"lunch"); } catch (SQLException e) {
                throw new RuntimeException(e); }
        ...
        addDish2.setOnAction(actionEvent ->{
            setAmountRefresh();
            try { loadDishLine(2,"lunch"); } catch (SQLException e) {
                throw new RuntimeException(e); }
            buttonCheckOrderField.setVisible(false);
            menuPreviewOrder.setText(setPreviewOrderText());
            showLineText();
        ...
        addDish3.setOnAction(actionEvent ->{
            setAmountRefresh();
            try { loadDishLine(3,"lunch"); } catch (SQLException e) {
                throw new RuntimeException(e); }
            buttonCheckOrderField.setVisible(false);
            menuPreviewOrder.setText(setPreviewOrderText());
            showLineText();
        ...
        addDish4.setOnAction(actionEvent ->{
            setAmountRefresh();
            try { loadDishLine(4,"lunch"); } catch (SQLException e) {
                throw new RuntimeException(e); }
            buttonCheckOrderField.setVisible(false);
            menuPreviewOrder.setText(setPreviewOrderText());
            showLineText();
