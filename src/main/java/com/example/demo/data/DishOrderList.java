...
public class DishOrderList {
    ...
    public DishOrderList() {
        LinkedList<List> dishOrderList = new LinkedList<>();

        //dishOrderList.add("00001", "EGGS","2.3", "breakfast");
       // 00001	EGGS	2.3	breakfast



        //dishOrderList.add(Integer.parseInt("00001"), "EGGS", Double.parseDouble(String.valueOf(2.3)),	"breakfast");
    ...
    public void dishMapOrderUpload(ArrayList dishList){
